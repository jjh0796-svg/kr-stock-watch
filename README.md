...
5. **공매도 급증** — 관심종목의 공매도 비중·잔고 급증 (pykrx, KRX 로그인 필요 — 실패 시 사유 표시)
...
| `/목록` | 현재 관심종목·설정 확인 |
| `/유형` | 공시 유형별 켜짐/꺼짐 보기 (자금조달·주주환원·지배구조·계약수주·리스크·실적·시장조치·오버행·5%보고) |
| `/유형 실적 끄기` | 해당 유형 알림 중단 (`켜기`로 복원) |
| `/키워드 추가 단어` | 공시 제목 감시 키워드 직접 추가 |
